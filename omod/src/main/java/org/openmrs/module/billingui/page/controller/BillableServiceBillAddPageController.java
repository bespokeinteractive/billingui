    ...
    public String post(HttpServletRequest request, PageModel model, Object command, BindingResult bindingResult,
        ...
        if (encounterId != null) {
            ...
            for (int i = 0; i < billItems.length(); i++) {
                ...
                unitPrice = NumberUtils.createBigDecimal(Integer.toString(incomingItem.getJSONObject("initialBill").getInt("price")));
                ...
                service = billingService.getServiceByConceptId(incomingItem.getJSONObject("initialBill").getInt("conceptId"));
            ...
            return "redirect:" + uiUtils.pageLink("billingui", "ipdbillingqueue");
            ...
            return "redirect:" + uiUtils.pageLink("billingui", "patientServiceBillForBD", params);
